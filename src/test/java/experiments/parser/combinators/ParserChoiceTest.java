...
public class ParserChoiceTest {
    ...
    public void should_always_return_success_when_input_start_by_given_first_character(
        ...
        Parser<Integer> choice = Parser.choice(Parser.pChar(charToMatch1),
                Parser.pChar(charToMatch2), Parser.pChar(charToMatch3));
        assertThat(choice.apply(input)).isEqualTo(Result.success(charToMatch1, remaining));
    }
    ...
    public void should_always_return_success_when_input_start_by_given_second_character(
        ...
        Parser<Integer> choice = Parser.choice(Parser.pChar(charToMatch1),
                Parser.pChar(charToMatch2), Parser.pChar(charToMatch3));
        assertThat(choice.apply(input)).isEqualTo(Result.success(charToMatch2, remaining));
    }
    ...
    public void should_always_return_success_when_input_start_by_given_third_character(
        ...
        Parser<Integer> choice = Parser.choice(Parser.pChar(charToMatch1),
                Parser.pChar(charToMatch2), Parser.pChar(charToMatch3));
        assertThat(choice.apply(input)).isEqualTo(Result.success(charToMatch3, remaining));
    }
    ...
    public void should_always_return_failure_when_input_not_start_by_given_character(
        ...
        Parser<Integer> choice = Parser.choice(Parser.pChar(charToMatch1),
                Parser.pChar(charToMatch2), Parser.pChar(charToMatch3));
        assertThat(choice.apply(input)).isEqualTo(Result.failure("Expecting %c, got %c", charToMatch3, firstChar));
    }
}
